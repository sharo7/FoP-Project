...
//this function should be called at the end of the program for every sprite
//that has used sound to free the memory from all of them

void soundInitializer();
// this should be added at the first of the program to initialize the sound
